// ClosingSlide.tsx — "thanks" word-shape centered, organic shapes floating in background
...
const BG_SHAPES = [
  { shape: SHAPES.bird,    opacity: 0.08, floatAmp: 5,  floatDuration: 11, phase: 0,   style: { left: '2%',  top: '5%',  width: '14%', height: '14%' } },
  { shape: SHAPES.sunBlob, opacity: 0.07, floatAmp: 4,  floatDuration: 14, phase: 0.3, style: { right: '3%', top: '8%',  width: '12%', height: '12%' } },
  { shape: SHAPES.cloud,   opacity: 0.06, floatAmp: 6,  floatDuration: 17, phase: 0.7, style: { left: '8%',  bottom: '10%', width: '16%', height: '16%' } },
  { shape: SHAPES.face,    opacity: 0.06, floatAmp: 3,  floatDuration: 13, phase: 1.1, style: { right: '5%', bottom: '12%', width: '13%', height: '13%' } },
  { shape: SHAPES.man,     opacity: 0.05, floatAmp: 4,  floatDuration: 16, phase: 0.5, style: { left: '20%', top: '3%',  width: '10%', height: '10%' } },
  { shape: SHAPES.sun,     opacity: 0.07, floatAmp: 5,  floatDuration: 12, phase: 1.4, style: { right: '18%', bottom: '5%', width: '11%', height: '11%' } },
  { shape: SHAPES.bird,    opacity: 0.05, floatAmp: 3,  floatDuration: 19, phase: 0.9, style: { right: '22%', top: '5%',  width: '9%',  height: '9%' } },
  { shape: SHAPES.mountain,opacity: 0.06, floatAmp: 4,  floatDuration: 15, phase: 0.2, style: { left: '38%', bottom: '4%', width: '12%', height: '12%' } },
];
...
export default function ClosingSlide({ slide }: { slide: ClosingSlideData }) {
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center overflow-hidden">
      ...
      {/* "thanks" word-shape — large, centered */}
      <motion.div
        className="relative z-10 w-[82%] max-w-[900px]"
